...
<html>
    ...
    <body>
        <div id="loginDialog">
            <div id="loginDialogTitle">JunoDoc - Register</div>
            <div id="loginForm">
                ...
                <p><label for="passwordRepeat">Repeat Password</label></p>
                <p><input type="password" name="passwordRepeat" id="passwordRepeat" required /></p>
                <div id="registrationMessage">
                    <p>Already registered? <a href="/">Login now!</a>
                </div>
            </div>
            <div id="loginButtons">
                <div class="button" title="Register"><i class="fa fa-floppy-o" aria-hidden="true"></i></div>
            </div>
        </div>
    </body>
</html>
